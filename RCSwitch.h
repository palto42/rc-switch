...
class RCSwitch {
  ...
  public:
    ...
    void switchOnZap(const char* sGroup, int nChannel);
    void switchOffZap(const char* sGroup, int nChannel);
  ...
  private:
    ...
    char* getCodeWordZ(const char* sGroup, int nDevice, bool bStatus);
